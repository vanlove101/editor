...
;(function(factory) {
    ...
    editormd.title        = editormd.$name = "Mangaii";
    editormd.version      = "1.0.0";
    editormd.homePage     = "http://mangaii.com/";
    ...
    editormd.defaults     = {
        ...
        lang : {
            name        : "zh-cn",
            description : "开源在线Markdown编辑器122<br/>Open source online Markdown editor.",
            tocTitle    : "目录",
            toolbar     : {
                undo             : "撤销（Ctrl+Z）",
                redo             : "重做（Ctrl+Y）",
    ...
    editormd.prototype    = editormd.fn = {
        ...
        createInfoDialog : function() {
            ...
            var infoDialogHTML = [
                ...
                "<p style=\"font-size: 0.85em;\">Copyright &copy;" +  this.lang.version,
                "</div>",
